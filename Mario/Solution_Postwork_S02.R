...
str(f_19_20); head(f_19_20); View(f_19_20); summary(f_19_20)
str(f_18_19); head(f_18_19); View(f_18_19); summary(f_18_19)
str(f_17_18); head(f_17_18); View(f_17_18); summary(f_17_18)

f_19_20 <- f_19_20 %>% select(Date, HomeTeam:FTR)
f_18_19 <- f_18_19 %>% select(Date, HomeTeam:FTR)
f_17_18 <- f_17_18 %>% select(Date, HomeTeam:FTR)

str(f_19_20); str(f_18_19); str(f_17_18)
